...
echo "  0: 企画部長 (config/panes.yaml の company.bucho_kikaku)"
echo "  1: 開発部長 (config/panes.yaml の company.bucho_kaihatsu)"
echo "  2: デザイン部長 (config/panes.yaml の company.bucho_design)"
echo "  3: QA部長 (config/panes.yaml の company.bucho_qa)"
echo ""
